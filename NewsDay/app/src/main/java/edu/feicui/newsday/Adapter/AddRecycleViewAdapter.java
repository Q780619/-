...
public class AddRecycleViewAdapter extends RecyclerView.Adapter<AddRecycleViewAdapter.MyViewHolder> {
    ...
    public AddRecycleViewAdapter(List<String> list, Context context) {
        this.list = list;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.add_add_item, parent, false);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            textView = (TextView) itemView.findViewById(R.id.add_item_tv);
        }
    }
