...
public class RecycleViewItem extends RecyclerView.ItemDecoration {
    ...
    private int mDividerHeight = 10;//分割线高度，默认为2px
...
//    getItemOffsets:通过outRect.set()为每个item设置偏移量。
     ...
     */
    public RecycleViewItem(Context context, int orientation) {
     ...
     */
    public RecycleViewItem(Context context, int orientation, int drawableId) {
     ...
     */
    public RecycleViewItem(Context context, int orientation, Drawable drawable) {
        this(context, orientation);
        mDivider = drawable;
        mDividerHeight = mDivider.getIntrinsicHeight();
    }
     ...
     */
    public RecycleViewItem(Context context, int orientation, Drawable drawable, int
            drawableHeight) {
        this(context, orientation);
        mDivider = drawable;
     ...
     */
    public RecycleViewItem(Context context, int orientation, int dividerHeight, int
            dividerColor) {
        this(context, orientation);
